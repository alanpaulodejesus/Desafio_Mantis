...
public class PropriedadesTarefas {



    public static final String categoriaBug = "Bug";
    public static final String categoriaDúvida = "Dúvida";
    ...
    public static final String reproduzirBug = "1 - Bug \n"
                                                +"2 - Bug \n"
                                                +"3 - Bug";
